  ...
  (() => {
    ...
    var E = ((e) =>
      typeof require < "u"
        ...
        : typeof Proxy < "u"
        ? new Proxy(e, {
            get: (o, i) => (typeof require < "u" ? require : o)[i],
          })
        : e)(function (e) {
    ...
    var Ie = (e, o, i) => (
      ...
      ue(
        o || !e || !e.__esModule
          ? W(i, "default", { value: e, enumerable: !0 })
          : i,
        e
      )
    );
    ...
    h();
    f();
    var Fi = __STORYBOOK_CLIENT_LOGGER__,
      {
        deprecate: Hi,
        logger: K,
        once: qi,
...
`
              ...
              .map(function (s, S) {
                return S === 0 ? s : "".concat(a).concat(s);
              }).join(`
`)),
            (l += I + r[n + 1]);
        }),
    ...
    var ne = "storybook/background",
      ...
      te = (0, Y.default)(1e3)((e, o, i, r, c, d) => ({
        id: e || o,
        title: o,
        onClick: () => {
          c({ selected: i, name: o });
        ...
        value: i,
        right: r ? g.createElement(he, { background: i }) : void 0,
        active: d,
      })),
      ge = (0, Y.default)(10)((e, o, i) => {
        let r = e.map(({ name: c, value: d }) =>
          te(null, c, d, !0, i, d === o)
        );
        return o !== "transparent"
          ? [te("reset", "Clear background", "transparent", null, i, !1), ...r]
          : r;
      }),
      ...
      Ce = B(function () {
        let [e, o] = L(),
          { grid: i } = P(y, { grid: { disable: !1 } });
        if (i?.disable) return null;
        let r = e[y]?.grid || !1;
        return g.createElement(
          w,
          {

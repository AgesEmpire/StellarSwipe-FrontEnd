# Issue #166 - Referral Program Tracking Dashboard
...
- Active referrals list with statuses: placeholder data
- Earnings summary: UI placeholders
- Referral reward tier system display: placeholder
- Historical earnings chart: placeholder
- Withdraw earnings option: UI stub

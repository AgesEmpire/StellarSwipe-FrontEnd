      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="mt-3 flex flex-wrap items-center gap-2">
            ...
            <button
              onClick={handleExitDemo}
              className="inline-flex items-center gap-1.5 rounded-lg border border-amber-500/20 px-3 py-1.5 text-xs font-medium text-amber-400/80 hover:bg-amber-500/10 transition-colors"
            ...
            <button
              onClick={handleReset}
              className="inline-flex items-center gap-1 rounded-lg px-2 py-1.5 text-xs text-amber-500/60 hover:text-amber-400/80 transition-colors"
